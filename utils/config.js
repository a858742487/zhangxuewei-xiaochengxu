...
var DOMAIN = "highnewtech.com/wordpressZXW";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="张雪微Lite"; //网站名称
...
var PAYTEMPPLATEID = 'nDHGpmVvmOxqeJ_PqHxK216ZXtTtsG-Hr3pQ4VMAzWw';//赞美消息模版id
var REPLAYTEMPPLATEID = 'nDHGpmVvmOxqeJ_PqHxK216ZXtTtsG-Hr3pQ4VMAzWw';//回复评论消息模版id
var ZANIMAGEURL = '';//微信赞美的图片链接，用于个人小程序的赞美
...
var INDEXNAV = [
  ...
  { id: '2', name: '最新', image: '../../images/shop.png', url: '../comments/comments', redirecttype: 'apppage', appid: '', extraData:'' },
    { id: '3', name: '张雪微', image: '../../images/app.png', url: '../page/page?categoryID=98', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
